...
class SegTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        internal_features.append(F.interpolate(x, scale_factor=2, mode="bilinear", align_corners=False))
        ...
        if not self.training:
            internal_features.append(F.interpolate(x, size=(H*2, W*2-1), mode="bilinear", align_corners=False))
        else:
            internal_features.append(F.interpolate(x, size=(H*2, W*2), mode="bilinear", align_corners=False))
